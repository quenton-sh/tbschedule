...
//		}
	...
	/**
	 * 以执行任务类名(ex:BillDeleteByIdTask)，记录eagleeye调研链的来源
	 * @throws no exception
	 * xiujue, 20160913
	 */
	public static void startEagleEyeTrace(String taskClzName) {
	    String traceId = EagleEye.generateTraceId(getLocalIP());
        EagleEye.startTrace(traceId, "time://tbschedule/" + taskClzName);
	}
	 ...
	 * xiujue, 20160913
	 */
	public static void endEagleEyeTrace() {
	    EagleEye.endTrace();
	}
